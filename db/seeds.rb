...
User.create!(name: 'Merchant Employee', address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, email: 'Merchant@example.com', password: 'Merchant', merchant: megan)
User.create!(name: 'Test', address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, email: 'Test@example.com', password: 'Test')
